...
class App extends Sprite {
	...
	public constructor () {
		...
		var dodecagon = new Sprite ();
		dodecagon.graphics.beginFill (0xff0000);
		this.drawPolygon (dodecagon.graphics, 50, 50, 50, 12);
		dodecagon.x = 780;
		dodecagon.y = 150;
		this.addChild (dodecagon);
		...
		var curve2 = new Sprite ();
		curve2.graphics.lineStyle(10, 0xff0000, 0.3);
		curve2.graphics.curveTo (390.5, 200, 300, -50);
		curve2.x = 200;
		curve2.y = 380;
...
var stage = new Stage (900, 500, 0xFFFFFF, App);
